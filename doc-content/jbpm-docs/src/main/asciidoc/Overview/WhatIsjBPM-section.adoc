...
//image::/content/repositories/llu/_images/Overview/Process.png[]
...
jBPM focuses on executable business processes, which are business processes that contain enough detail so they can actually be executed on a BPM jBPM engine.
...
//image::/content/repositories/llu/_images/Overview/kie-wb-after-login.png[]
...
jBPM is not just an isolated jBPM engine.
