...
IMPORTANT: Notice that the mentioned roles and group configurations are related to the KIE Server, not to Business Central (in case they have separate user configurations).
